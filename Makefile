...
OFILES = main.o mylib.o font.o text.o splash2.o winScreen.o loseScreen.o border.o player.o block.o fire.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h text.h splash2.h winScreen.h loseScreen.h border.h player.h block.h fire.h
